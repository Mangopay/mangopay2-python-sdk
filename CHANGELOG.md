...
- Support for the [GET List Wallets for a User](https://docs.mangopay.com/api-reference/wallets/list-wallets-user) endpoint (#457)
- Support for the `Licensor` property on [GET View a Client](https://docs.mangopay.com/api-reference/client/view-client) (#455)
- Support for [GET View card details for a Web Card PayIn](https://docs.mangopay.com/api-reference/web-card-payins/view-card-details-web-card-payin) endpoint (#458)

### Changed
- `x-tenant-id` deprecated as no longer necessary for UK platforms; the parameter is ignored by Mangopay (#455 )
