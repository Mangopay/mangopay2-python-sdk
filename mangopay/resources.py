...
class UboDeclaration(BaseModel):
    ...
    class Meta:
        verbose_name = 'KYC/ubodeclaration'
        verbose_name_plural = 'KYC/ubodeclarations'
        url = '/users/%(user_id)s/KYC/ubodeclarations'
...
class Ubo(BaseModel):
    ...
    is_active = BooleanField(api_name='IsActive', default=True)
    ubo_declaration = ForeignKeyField(UboDeclaration)
    user = ForeignKeyField(UboDeclaration)

    class Meta:
        verbose_name = 'ubo'
        verbose_name_plural = 'ubos'
        url = '/users/%(user_id)s/KYC/ubodeclarations/%(ubo_declaration_id)s/ubos'
